...
Monthly_Data = Monthly_Data[1:805,]
...
write.csv(Sharpe_arith1, "Sharpe_arith1.csv", row.names=FALSE, quote=FALSE)
write.csv(Sharpe_arith2, "Sharpe_arith2.csv", row.names=FALSE, quote=FALSE)
write.csv(Sharpe_geom1, "Sharpe_geom1.csv", row.names=FALSE, quote=FALSE)
write.csv(Sharpe_geom2, "Sharpe_geom2.csv", row.names=FALSE, quote=FALSE)
write.csv(arith_rrr, "arith_rrr.csv", row.names=FALSE, quote=FALSE)
write.csv(geom_rrr, "geom_rrr.csv", row.names=FALSE, quote=FALSE)
write.csv(STD, "STD.csv", row.names=FALSE, quote=FALSE)

Sharpe_arith1 = read.csv("Sharpe_arith1.csv")
Sharpe_arith2 = read.csv("Sharpe_arith2.csv")
Sharpe_geom1 = read.csv("Sharpe_geom1.csv")
Sharpe_geom2 = read.csv("Sharpe_geom2.csv")
arith_rrr = read.csv("arith_rrr.csv")
geom_rrr = read.csv("geom_rrr.csv")
STD = read.csv("STD.csv")



stats12 = data.frame(matrix(nrow=101, ncol = 18))
colnames(stats12) = c("Allocation", "Spread_num", "arith_Mean", "arith_STD_DEV", "arith_Sharpe1", "arith_Sharpe1_std", "arith_Sharpe2", "arith_Sharpe2_std", "arith_RRR",  "arith_RRR_std", "Geom_Mean", "Geom_STD_DEV", "Geom_Sharpe1", "Geom_Sharpe1_std", "Geom_Sharpe2", "Geom_Sharpe2_std", "Geom_RRR",  "Geom_RRR_std")
...
```{r}
# Monthly arithmetic rrr ratio CI
signif_pts0 = signif_Prob
col_pal <- c(signif_pts0$Rank_Color)
ggplot(data = stats212, aes(x = Spread_num, y = Prob)) + 
  geom_point() + 
  geom_label(data=signif_pts0[2,], aes(x = Spread_num, y = Prob, 
                                   label = paste0(100* round(Prob, 4), "%")),
             color = "darkgreen", size=4, nudge_y = -0.05) + 
  geom_point(data = signif_pts0, aes(color=Allocation), size=5)+
  scale_color_manual(values = col_pal)+
  labs(title = "Arithmetic Monthly Average Return: \n P[Risk Reward Ratio > 1]")+
  ylab("Probability") +
  xlab("Allocation (Large Cap)") +
  theme(plot.title = element_text(hjust = 0.5, size =18),
        axis.text = element_text(size = 12),
...
# Monthly arithmetic RRR
signif_pts0 = signif1_arith_RRR_std
col_pal <- c(signif_pts0$Rank_Color)
ggplot(data = stats12, aes(x = arith_RRR_std, y = arith_RRR)) + 
  geom_point() + 
  geom_label(data=signif_pts0[3,], aes(x = arith_RRR_std, y = arith_RRR, 
                                   label = paste0(
                                     "Mean: ", round(arith_RRR, 4), "\n", 
                                     "SD: ", round(arith_RRR_std, 4))),
  ...
  geom_point(data = signif_pts0, aes(color=Allocation), size=5)+
  scale_color_manual(values = col_pal)+
  labs(title = "Arithmetic Monthly Average Return Risk Reward Ratio: \n Mean vs. Standard Deviation") +
  ylab("Mean") +
  xlab("Standard Deviation") +
  theme(plot.title = element_text(hjust = 0.5, size =18),
        axis.text = element_text(size = 12),
...
```{r}
# Monthly Geommtric mean CI
signif_pts0 = signif_Geom_CI
col_pal <- c(signif_pts0$Rank_Color)
ggplot(data = stats212, aes(x = Spread_num, y = Geom_CI)) + 
  geom_point() + 
  geom_label(data=signif_pts0[2,], aes(x = Spread_num, y = Geom_CI, 
                                   label = paste0(
                                     "95% CI:", "\n", "[", round(Geom_CI, 4), ", ", 
                                     round(Geom_CI2, 4),"]")),
             color = "darkgreen", size=4, nudge_y = -0.01, nudge_x = -6) + 
  geom_point(data = signif_pts0, aes(color=Allocation), size=5)+
  scale_color_manual(values = col_pal)+
  labs(title = "Geometric Monthly Average Returns: \n Confidence Interval") +
  ylab("Lower Bound") +
  xlab("Allocation (Large Cap)") +
  theme(plot.title = element_text(hjust = 0.5, size =18),
        axis.text = element_text(size = 12),
...
# Monthly Geometric mean vs std
signif_pts0 = signif1_Geom_STD_DEV
col_pal <- c(signif_pts0$Rank_Color)
ggplot(data = stats12, aes(x = Geom_STD_DEV, y = Geom_Mean)) + 
  geom_point() + 
...
# Monthly Geometric sharpe1 CI
signif_pts0 = signif_Geom_Sharpe1_CI
col_pal <- c(signif_pts0$Rank_Color)
ggplot(data = stats212, aes(x = Spread_num, y = Geom_Sharpe1_CI)) + 
  geom_point() + 
  geom_label(data=signif_pts0[2,], aes(x = Spread_num, y = Geom_Sharpe1_CI, 
                                   label = paste0(
                                     "95% CI:", "\n", "[", round(Geom_Sharpe1_CI, 4), ", ", 
                                     round(Geom_Sharpe1_CI2, 4),"]")),
             color = "darkgreen", size=4, nudge_y = -0.01) + 
  geom_point(data = signif_pts0, aes(color=Allocation), size=5)+
  scale_color_manual(values = col_pal)+
  labs(title = "Geometric Monthly Sharpe Ratio (Inflation Adjusted): \n Confidence Interval") +
  ylab("Lower Bound") +
  xlab("Allocation (Large Cap)") +
  theme(plot.title = element_text(hjust = 0.5, size =18),
        axis.text = element_text(size = 12),
...
# Monthly Geometric mean sharpe ratio1
signif_pts0 = signif1_Geom_Sharpe1_std
col_pal <- c(signif_pts0$Rank_Color)
ggplot(data = stats12, aes(x = Geom_Sharpe1_std, y = Geom_Sharpe1)) +
  geom_point() +
  geom_label(data=signif_pts0[3,], aes(x = Geom_Sharpe1_std, y = Geom_Sharpe1,
                                   label = paste0(
                                     "Mean: ", round(Geom_Sharpe1, 4), "\n",
                                     "SD: ", round(Geom_Sharpe1_std, 4))),
             color = "darkgreen", size=4, nudge_y = 0.025, nudge_x=0.1) +
  geom_point(data = signif_pts0, aes(color=Allocation), size=5)+
  scale_color_manual(values = col_pal)+
  labs(title = "Geometric Monthly Sharpe Ratio (Inflation Adjusted): \n Mean vs. Standard Deviation") +
  ylab("Mean") +
...
# Monthly Geometric sharpe2 CI
signif_pts0 = signif_Geom_Sharpe2_CI
col_pal <- c(signif_pts0$Rank_Color)
ggplot(data = stats212, aes(x = Spread_num, y = Geom_Sharpe2_CI)) + 
  geom_point() + 
  geom_label(data=signif_pts0[2,], aes(x = Spread_num, y = Geom_Sharpe2_CI, 
                                   label = paste0(
                                     "95% CI:", "\n", "[", round(Geom_Sharpe2_CI, 4), ", ", 
                                     round(Geom_Sharpe2_CI2, 4),"]")),
             color = "darkgreen", size=4, nudge_y = -0.025) + 
  geom_point(data = signif_pts0, aes(color=Allocation), size=5)+
  scale_color_manual(values = col_pal)+
...
# Monthly Geom sharpe2
signif_pts0 = signif1_Geom_Sharpe2_std
col_pal <- c(signif_pts0$Rank_Color)
ggplot(data = stats12, aes(x = Geom_Sharpe2_std, y = Geom_Sharpe2)) + 
  geom_point() + 
  geom_label(data=signif_pts0[4,], aes(x = Geom_Sharpe2_std, y = Geom_Sharpe2, 
                                   label = paste0(
                                     "Mean: ", round(Geom_Sharpe2, 4), "\n", 
                                     "SD: ", round(Geom_Sharpe2_std, 4))),
             color = "darkgreen", size=4, nudge_x = 0.01, nudge_y = -0.025) + 
...
signif_pts0 = signif_Prob2
col_pal <- c(signif_pts0$Rank_Color)
ggplot(data = stats212, aes(x = Spread_num, y = Prob2)) + 
  geom_point() + 
  geom_label(data=signif_pts0[2,], aes(x = Spread_num, y = Prob2, 
                                   label = paste0(100* round(Prob2, 4), "%")),
             color = "darkgreen", size=4, nudge_y = -0.05) + 
  geom_point(data = signif_pts0, aes(color=Allocation), size=5)+
  scale_color_manual(values = col_pal)+
  labs(title = "Geometric Monthly Average Return: \n P[Risk Reward Ratio > 1]")+
  ylab("Probability") +
  xlab("Allocation (Large Cap)") +
  theme(plot.title = element_text(hjust = 0.5, size =18),
        axis.text = element_text(size = 12),
...
# Monthly Geometric RRR
signif_pts0 = signif1_Geom_RRR_std
col_pal <- c(signif_pts0$Rank_Color)
ggplot(data = stats12, aes(x = Geom_RRR_std, y = Geom_RRR)) + 
  geom_point() + 
  geom_label(data=signif_pts0[3,], aes(x = Geom_RRR_std, y = Geom_RRR, 
                                   label = paste0(
                                     "Mean: ", round(Geom_RRR, 4), "\n", 
                                     "SD: ", round(Geom_RRR_std, 4))),
             color = "darkgreen", size=4, nudge_x = 0.025) + 
  geom_point(data = signif_pts0, aes(color=Allocation), size=5)+
  scale_color_manual(values = col_pal)+
  labs(title = "Geometric Monthly Average Return Risk Reward Ratio: \n Mean vs. Standard Deviation") +
  ylab("Mean") +
  xlab("Standard Deviation") +
  theme(plot.title = element_text(hjust = 0.5, size =18),
        axis.text = element_text(size = 12),
...
signif1_arith_Sharpe1_1 = signif1_arith_Sharpe1[,c(1,2,3,5,6)]
signif1_arith_Sharpe1_1["Type"] = colnames(signif1_arith_Sharpe1_1)[3]
colnames(signif1_arith_Sharpe1_1)[3] = "value"


signif1_arith_Sharpe2_1 = signif1_arith_Sharpe2[,c(1,2,3,5,6)]
signif1_arith_Sharpe2_1["Type"] = colnames(signif1_arith_Sharpe2_1)[3]
colnames(signif1_arith_Sharpe2_1)[3] = "value"

signif1_Geom_Sharpe1_1 = signif1_Geom_Sharpe1[,c(1,2,3,5,6)]
signif1_Geom_Sharpe1_1["Type"] = colnames(signif1_Geom_Sharpe1_1)[3]
colnames(signif1_Geom_Sharpe1_1)[3] = "value"

signif1_Geom_Sharpe2_1 = signif1_Geom_Sharpe2[,c(1,2,3,5,6)]
signif1_Geom_Sharpe2_1["Type"] = colnames(signif1_Geom_Sharpe2_1)[3]
colnames(signif1_Geom_Sharpe2_1)[3] = "value"


a1 = stats_total[,c(1,2,5)]
a1["Type"] = colnames(a1)[3]
colnames(a1)[3] = "value"

a2 = stats_total[,c(1,2,6)]
a2["Type"] = colnames(a2)[3]
colnames(a2)[3] = "value"

g1 = stats_total[,c(1,2,10)]
g1["Type"] = colnames(g1)[3]
colnames(g1)[3] = "value"

g2 = stats_total[,c(1,2,11)]
g2["Type"] = colnames(g2)[3]
colnames(g2)[3] = "value"
...
# signif_pts0 = signif_arith_Sharpe2_CI
# col_pal <- c(signif_pts0$Rank_Color)
ggplot(data = sharpe, aes(x = Spread_num, y = value, facet = factor(Type))) + 
  facet_wrap(~Type) +
  geom_point() + 
  geom_point(data = signif_pts0, aes(x = Num, y = win_loss, facet = factor(Type)), color = "green3", size=5) +
  # scale_color_manual(values = col_pal)+
...
signif_pts0 = rbind(signif1_arith_Sharpe1_1, signif1_arith_Sharpe2_1, signif1_Geom_Sharpe1_1, signif1_Geom_Sharpe2_1)
signif_pts1 = signif_pts0[c(1,5,9,13,2,10,14,6,3,7,11,15,4,8,12,16),]



for(i in )
col_pal <- c(signif_pts1$Rank_Color)
ggplot(data = sharpe, aes(x = Spread_num, y = value, facet = factor(Type))) + 
  facet_wrap(~Type, scales = "free") +
  geom_point() + 
  geom_label(data=signif_pts1, aes(x = Spread_num, y = value, 
                                   label = paste0(
                                     "Sharpe Ratio: ", round(value, 4))),
             color = "darkgreen", size=4, nudge_y = -0.035, nudge_x = 0.004) +
...
signif_pts0 = signif_Prob
col_pal <- c(signif_pts0$Rank_Color)
ggplot(data = stats_total_CI, aes(x = Spread_num, y = Prob)) + 
  geom_point() + 
  geom_label(data=signif_pts0[2,], aes(x = Spread_num, y = Prob, 
                                   label = paste0(100* round(Prob, 4), "%")),
             color = "darkgreen", size=4, nudge_y = -0.05) + 
...
signif_pts0 = signif_Geom_CI
col_pal <- c(signif_pts0$Rank_Color)
ggplot(data = stats_total_CI, aes(x = Spread_num, y = Geom_CI)) + 
  geom_point() + 
  geom_label(data=signif_pts0[2,], aes(x = Spread_num, y = Geom_CI, 
                                   label = paste0(
                                     "95% CI:", "\n", "[", round(Geom_CI, 4), ", ", 
...
signif_pts0 = signif_Geom_Sharpe1_CI
col_pal <- c(signif_pts0$Rank_Color)
ggplot(data = stats_total_CI, aes(x = Spread_num, y = Geom_Sharpe1_CI)) + 
  geom_point() + 
  geom_label(data=signif_pts0[2,], aes(x = Spread_num, y = Geom_Sharpe1_CI, 
                                   label = paste0(
                                     "95% CI:", "\n", "[", round(Geom_Sharpe1_CI, 4), ", ", 
...
signif_pts0 = signif_Geom_Sharpe2_CI
col_pal <- c(signif_pts0$Rank_Color)
ggplot(data = stats_total_CI, aes(x = Spread_num, y = Geom_Sharpe2_CI)) + 
  geom_point() + 
  geom_label(data=signif_pts0[2,], aes(x = Spread_num, y = Geom_Sharpe2_CI, 
                                   label = paste0(
                                     "95% CI:", "\n", "[", round(Geom_Sharpe2_CI, 4), ", ", 
